...
type TmpVariantsType = typeof tmpVariants;
type TmpVariantsProps = VariantProps<TmpVariantsType>;
type TmpProps = React.ComponentProps<"button"> &
  TmpVariantsProps & {
    render?: (params: { getVariantClx: TmpVariantsType }) => React.JSX.Element;
  };

export const Tmp = (props: TmpProps) => {
  const { render } = props;

  if (typeof render === "function")
    return render({ getVariantClx: tmpVariants });
