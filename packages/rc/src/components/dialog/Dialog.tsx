...
type DialogVariantsType = typeof dialogVariants;
type DialogVariantsProps = VariantProps<DialogVariantsType>;
type DialogProps = React.ComponentProps<"button"> &
  DialogVariantsProps & {
    render?: (params: {
      getVariantClx: DialogVariantsType;
    }) => React.JSX.Element;
  };
...
export const Dialog = (props: DialogProps) => {
  ...
  if (typeof render === "function")
    return render({ getVariantClx: dialogVariants });
